function heatmap(selector, data, options) {
  ...
  function colormap(svg, data, width, height) {
    ...
    var tip = d3.tip()
        ...
        .html(function(d, i) {
          var obj = JSON.parse(d.label);
          console.log(obj)
          // http://127.0.0.1:8000/
          // <td rowspan="11">' + '<img src=\"' + "http://127.0.0.1:8000/" + obj.photo + '/">' + '</td> \
          // "<tr><th align=\"right\">Row</th><td><img src=\"" + "http://127.0.0.1:8000/" + obj.photo + "\"/></td></tr>" +
http://127.0.0.1:8000/P1/100714_dinner.jpg
          return '<table> \
            <tr> \
              <td rowspan="12">' + '<img src="' + obj.photo + '"/>' + '</td> \
            </tr> \
            <tr> \
              <td>' + "<strong>" + obj.mealType + "</strong>" + '</td> \
            </tr> \
            <tr> \
              <td>' + "<strong>Blood Glucose Change:</strong>" + '</td> \
            </tr> \
            <tr> \
              <td>' + obj.BGchange + ' mg/dl' + '</td> \
            </tr> \
            <tr> \
              <td>' + "<strong>Calories:</strong>" + '</td> \
            </tr> \
            <tr> \
              <td>' + obj.calories + ' calories' + '</td> \
            </tr> \
            <tr> \
